...
const OrdersScreen = () => {
  ...
  const renderItem = ({ item }) => {
    ...
    <View style={{backgroundColor:Colors[colorScheme??'light'].background2,padding:8,borderRadius:10,marginBottom:15}}>
      <View >
        <View style={{flexDirection:'row',alignItems:'center',justifyContent:'space-between',borderBottomWidth:0.5,borderBottomColor:Colors[colorScheme??'light'].text,marginBottom:10}}>
